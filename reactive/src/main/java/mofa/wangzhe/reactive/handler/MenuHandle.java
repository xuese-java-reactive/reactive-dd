...
public class MenuHandle {
    ...
    @PreAuthorize("hasAuthority('MenuHandle-save')")
    ...
    @PreAuthorize("hasAuthority('MenuHandle-remove')")
    ...
    @PreAuthorize("hasAuthority('MenuHandle-update')")
     ...
     */
    @PreAuthorize("hasAuthority('MenuHandle-page')")
